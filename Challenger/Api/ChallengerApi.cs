...
namespace Slothsoft.Challenger.Api {
    internal class ChallengerApi : IChallengerApi {
        ...
        public ChallengerApi(IModHelper modHelper) {
            ...
            _challenges.Sort((a, b) => String.Compare(a.GetDisplayName(), b.GetDisplayName(), StringComparison.CurrentCulture));
        ...
        public void SetActiveChallenge(IChallenge activeChallenge) {
            if (activeChallenge != _activeChallenge) {
                ...
                ModEntry.Instance.Monitor.Log($"Challenge \"{_activeChallenge.GetDisplayName()}\" was ended.", LogLevel.Debug);
                ...
                ModEntry.Instance.Monitor.Log($"Challenge \"{_activeChallenge.GetDisplayName()}\" was activated.", LogLevel.Debug);
            }
        }
    }
